<%@ Page Title="当前位置：员工工作简历" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="ResumeForm.aspx.cs" Inherits="CY.EMS.WebSite.FileManage.ResumeForm" %>

<%@ Register Src="~/FileManage/ResumeUC.ascx" TagName="EdtResume" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; height: 161px">
            ...
            <td style="width: 100%; height: 100px; background-color: gainsboro">
                <dx:ASPxGridView ID="grdView" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="开始日期" VisibleIndex="2" FieldName="FromDate">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="结束日期" VisibleIndex="3" FieldName="ToDate">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="所在公司" VisibleIndex="4" FieldName="Company">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="所在部门" VisibleIndex="5" FieldName="Dept">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="担任职务" VisibleIndex="6" FieldName="Job">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="补充说明" VisibleIndex="6" FieldName="Memo">
                        </dx:GridViewDataTextColumn>
        ...
        <tr>
            <td>
                <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" HeaderText="员工工作简历" ClientInstanceName="popEdt"
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                            ...
                            <div>
                                <uc:EdtResume ID="ucResume" runat="server"></uc:EdtResume>

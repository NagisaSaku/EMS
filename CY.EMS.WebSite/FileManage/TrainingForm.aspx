<%@ Page Title="当前位置：员工培训纪录" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="TrainingForm.aspx.cs" Inherits="CY.EMS.WebSite.FileManage.TrainingForm" %>

<%@ Register Src="~/FileManage/TrainingUC.ascx" TagName="EdtTraining" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; height: 161px">
        ...
        <tr>
            <td style="width: 100%; height: 100px; background-color: gainsboro">
                <dx:ASPxGridView ID="grdView" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    OnPageIndexChanged="grdView_PageIndexChanged" OnBeforeColumnSortingGrouping="grdView_BeforeColumnSortingGrouping">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="培训开始日期" VisibleIndex="2" FieldName="FromDate">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="培训结束日期" VisibleIndex="3" FieldName="ToDate">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="培训单位" VisibleIndex="4" FieldName="TrainUnit">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="培训地址" VisibleIndex="5" FieldName="Address">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="培训内容" VisibleIndex="6" FieldName="TrainContent">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="培训花费" VisibleIndex="7" FieldName="Price">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="获得证书" VisibleIndex="8" FieldName="Certificate">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewCommandColumn Caption="操作" Width="140px" HeaderStyle-HorizontalAlign="Center"
                            CellStyle-HorizontalAlign="Center" VisibleIndex="11">
                            <CustomButtons>
                        ...
                        <dx:GridViewDataTextColumn Caption="培训获得证书" FieldName="Certificate" VisibleIndex="9">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="培训花费" FieldName="Price" VisibleIndex="8">
                        </dx:GridViewDataTextColumn>
                    </Columns>
        ...
        <tr>
            <td>
                <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" HeaderText="员工培训纪录" ClientInstanceName="popEdt"
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                            ...
                            <div>
                                <uc:EdtTraining ID="ucTraining" runat="server"></uc:EdtTraining>

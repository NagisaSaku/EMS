<%@ Page Title="当前位置：员工离职管理" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="TransferForm.aspx.cs" Inherits="CY.EMS.WebSite.FileManage.TransferForm" %>

<%@ Register Src="~/FileManage/TransferUC.ascx" TagName="EdtTransfer" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; height: 161px">
        <tr>
            <td align="left" style="font-size: 0.8em; width: 2232px; font-family: 宋体; height: 16px; background-color: #CED8F6">
                <table>
                    <tr>
                        ...
                        <td style="width: 50px" align="center">
                            <dx:ASPxLabel ID="lblEmpName" runat="server" Text="员工姓名" />
                        </td>
                        <td style="width: 120px">
                            <dx:ASPxTextBox ID="txtEmpName" runat="server" Width="100%" />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width: 100%; height: 100px; background-color: gainsboro">
                <dx:ASPxGridView ID="grdView" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn Caption="调度日期" VisibleIndex="3" FieldName="ValidDate">
                            <PropertiesDateEdit DisplayFormatString="yyyy-MM-dd" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="调度前部门" VisibleIndex="4" FieldName="FmDeptName">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="调动后部门" VisibleIndex="5" FieldName="ToDeptName">
                        </dx:GridViewDataTextColumn>
        ...
        <tr>
            <td>
                <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" HeaderText="员工工作调度" ClientInstanceName="popEdt"
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                            ...
                            <div>
                                <uc:EdtTransfer ID="ucTransfer" runat="server"></uc:EdtTransfer>
